...
**Bruce:** And of course, because it’s just CSS, you can say, display column block and give whatever fallback you want. And then you can say display column, paint, (masonry). And you get the cascade and you get the fallback. It’s the best of all worlds. And you said, Vadim, well, it’s going to slow things down. Basically, anything you do in JavaScript slows things down.

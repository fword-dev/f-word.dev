...
import { bundle as lightningcssBundle, browserslistToTargets } from 'lightningcss';
...
export default (config) => {
    ...
    config.setLibrary('md', markdown.use(markdownItNamedHeadings));
